...
def train(yaml_setting_path, debug_mode):
    ...
    for epoch in range(N_epochs):
        ...
        for batch_num, (indexes, batch_images, batch_poses, batch_poses_translation) in enumerate(data_loader):
            ...
            #start_backward = time()
            loss.backward()
            print(vae.dict_segments_means_means.grad)
            print("\n")
            print(vae.dict_segments_means_stds.grad)
            print("\n")
            print(vae.dict_segments_stds_means.grad)
            print("\n")
            print(vae.dict_segments_stds_stds.grad)
            print("\n")
            print(vae.dict_segments_proportions_means.grad)
            print("\n")
            print(vae.dict_segments_proportions_stds)
            print("\n\n\n\n\n\n")
