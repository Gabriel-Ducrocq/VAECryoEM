...
rotation_angle[:int(N_struct*N_pose_per_structure/2), :] = np.random.normal(size=(N_struct*N_pose_per_structure/2))*0.1 -np.pi/3
rotation_angle[int(N_struct*N_pose_per_structure/2):, :] = np.random.normal(size=(N_struct*N_pose_per_structure/2))*0.1 -2*np.pi/3
...
rotate_domain_pdb_structure_axis_angle
