...
ctf_params[:, 2] = image_settings["rendered"]["dfU"]
ctf_params[:, 3] = image_settings["rendered"]["dfV"]
ctf_params[:, 4] = image_settings["rendered"]["dfang"]
ctf_params[:, 5] = image_settings["rendered"]["accelerating_voltage"]
ctf_params[:, 6] = image_settings["rendered"]["spherical_aberration"]
ctf_params[:, 7] = image_settings["rendered"]["amplitude_contrast_ratio"]
ctf_params[:, 8] = 0
