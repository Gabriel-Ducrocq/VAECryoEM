...
ctf_params[:, 2] = image_settings["renderer"]["dfU"]
ctf_params[:, 3] = image_settings["renderer"]["dfV"]
ctf_params[:, 4] = image_settings["renderer"]["dfang"]
ctf_params[:, 5] = image_settings["renderer"]["accelerating_voltage"]
ctf_params[:, 6] = image_settings["renderer"]["spherical_aberration"]
ctf_params[:, 7] = image_settings["renderer"]["amplitude_contrast_ratio"]
ctf_params[:, 8] = 0
