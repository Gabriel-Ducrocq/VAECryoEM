...
def compute_distance(polymer, idxA, idxB, chain_id, idx):
...
def compute_distance_no_chain(polymer, idxA, idxB, idx):
...
def compute_distribution_distances(path, idxA, idxB, predicted=False, chain_id = ["A", "B"], chain_information=True):
    ...
    for i in prange(start, end):
        ...
        if chain_information:
            dist = compute_distance(pol, idxA, idxB, chain_id, i)
        else:
            dist = compute_distance_no_chain(pol, idxA, idxB, i)
