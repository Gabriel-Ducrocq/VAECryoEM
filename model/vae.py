...
class VAE(torch.nn.Module):
    ...
    def sample_latent(self, images, indexes=None):
        ...
        if not self.amortized:
            #assert indexes is None, "If using a non-amortized version of the code, the indexes of the images must be provided"
    ...
    def decode(self, latent_variables):
        ...
        if self.latent_type == "continuous":
            ...
            axis_angle_per_domain = angle_per_domain[:, :, None]*axis_per_domain
